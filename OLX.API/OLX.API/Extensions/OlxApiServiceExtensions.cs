    ...
    public static class OlxApiServiceExtensions
    {
        ...
        public static void AddOlxApiConfigurations(this IServiceCollection services,IConfiguration configuration)
        {
            ...
            services.AddCors(options =>
            {
                ...
                builder =>
                {
                    builder.WithOrigins("http://localhost:3000", "http://localhost", "https://app.pluton.pp.ua", "http://stage.pluton.pp.ua:3000", "http://stage.pluton.pp.ua", "https://stage.pluton.pp.ua:3000", "https://stage.pluton.pp.ua")
                           .AllowAnyHeader()
                           .AllowAnyMethod()
                           .AllowCredentials();
                });

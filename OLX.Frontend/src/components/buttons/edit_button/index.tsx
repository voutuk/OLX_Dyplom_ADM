...
import { IEditButtonProps } from "./props";

const EditButton: React.FC<IEditButtonProps> = ({id, className}) => {
    const navigate = useNavigate();
    return (
        <svg className={className} onClick={() => {navigate(`advert/edit/${id}`)}} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
